...
function Drawer({
  ...
  const contextValue = React.useMemo(
    () => ({ blurOverlay, hasSnapPoints, modal, showSwipeHandle, swipeDirection }),
    [blurOverlay, hasSnapPoints, modal, showSwipeHandle, swipeDirection]
  )
...
function DrawerOverlay({
  ...
  blur = true,
  ...props
}: DrawerPrimitive.Backdrop.Props & { blur?: boolean }) {
  return (
...
function DrawerContent({
  ...
  const { blurOverlay, hasSnapPoints, modal, showSwipeHandle, swipeDirection } =
    useDrawer()
  const swipeAxis =
